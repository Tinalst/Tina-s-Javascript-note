...
// import 'three/examples/js/loaders/Jso';
...
export class JsonModelComponent implements OnInit, AfterViewInit {
  ...
  createModel = () => {
    ...
    jsonLoader.load('assets/models/json/lightmap.json', (geometry) => {

      // 添加纹理
      const texttureLoader = new THREE.TextureLoader();
      const map = texttureLoader.load('assets/textures/fastfood.png');
      const materials = new THREE.MeshPhongMaterial({map: map});
  ...
  private startRendering() {
    ...
    const component: JsonModelComponent = this;
